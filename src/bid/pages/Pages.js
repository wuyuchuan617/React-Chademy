...
function Pages(props){
  const {setCartAmount, cartamount}=props
    ...
    return(
        ...
        <Bid price={price} setTotalb={setTotalb} totalb={totalb} setPrice={setPrice} pname={pname} setPname={setPname} data={data} setData={setData}  s_date={s_date} e_date={e_date}/>
          </Route>
          <Route path={`/pages/desc/record/:id?`}>
          <Desc price={price} setPrice={setPrice} pname={pname} setPname={setPname} data={data}  setCartAmount={setCartAmount} cartamount={cartamount} />
          </Route>
