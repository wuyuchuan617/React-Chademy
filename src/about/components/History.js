      ...
      <div class="container">
          ...
          <div class="row no-gutters justify-content-between">
            ...
            <div className="a_popularText col-8">
              ...
              <p className="a_historycontent">功能設計要方便於消費者生活多樣的收納性，形式風格以能符合現代空間簡約、時尚的美學品味，卻不失家具的實用、實惠的本質，是CHADEMY努力的主張與態度。</p>
                </div>
              </div>
            </div>
          </div>
          <div class="a_historytwo">
                      <div class="row no-gutters">
              <div className="article col-md-12 mb-12 d-flex">
            <div className="a_historyImg">
        ...
        <div className="a_article2 col-md-6 mb-12">
          ...
          <div className="a_circle5"></div>
            ...
            <div className="a_popularText col-8">
              ...
              <p className="a_historycontent">1952年創立自有品牌CHADEMY家具， 取名CHADEMY 的概念是來自奧地利宮廷音樂家Johann Strauss（約翰史特勞斯）。</p>
                </div>
              </div>
            </div>
          </div>

          <div class="a_historyfour">
                      <div class="row no-gutters">
              <div className="article col-md-12 mb-12 d-flex">
            <div className="a_historyImg">
            ...
            <div className="a_popularText col-8">
              ...
              <p className="a_historycontent">1952年創立自有品牌CHADEMY家具， 取名CHADEMY 的概念是來自奧地利宮廷音樂家。</p>
                </div>
              </div>
            </div>
          </div>
           ...
           <div class="a_historyfive">
            ...
            <div className="a_popularText col-8">
              ...
              <p className="a_historycontent">更為了貼近瞭解消費者的多元的生活，於2006年成「CHADEMY」門市通路，藉由家具在空間中配置的各項服務的過程，提案給消費者各種符合生活機能的家具；並將這樣與消費者互動的實質經驗，應用於家具研發，以相輔相成。</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="membertitle">未來展望</div>
          <div class="membertitle2">期許拓展更多的門市以及產品，並且孕育更多對木工產業有意義的人才，創作叫好又叫座的商品，最重要的是，將富有教育意義的理念傳達給更多人知道。</div>
