    ...
    <>
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <div className="e_par">
            {/* <div className="text"> */}
            <div className="e_text1">募資條款須知：</div>

            <div className="tb">
              <div className="e_text"> 一、接受條款</div>
              ...
              <div className="e_text"> 二、條款修改</div>
              ...
              <div className="e_text">五、隱私權政策</div>
              您提供的註冊信息及Chedemy保留的有關您的若干其它資料將受到中華民國有關隱私的法律和本公司《隱私權政策》之規範。
              <div className="e_text">六、使用規定和條約</div>
              ...
              <div className="e_text">七、贊助以及商業行為規定</div>
