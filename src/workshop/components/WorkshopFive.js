                ...
                <div class="article col-md-4 mb-4">
                    <div class="boxtrain">
                        ...
                        <div class="word2">
                            <div class="word3">
                                <h4>丈量繪圖</h4>
                                <p>按照製作的產品量製產品尺寸，包含長、寬、高等，並繪製於同比例的白紙上。
                                </p>
                            </div>  
                        </div>
                    </div>
                ...
                <div class="article col-md-4 mb-4">
                    <div class="boxtrain">
                        ...
                        <div class="word2">
                            <div class="word3">
                                <h4>木頭拼貼</h4>
                                <p>裁切完的各式各樣的木頭，透過白膠等黏著劑，將木頭進行拼貼工法。
                                </p>
                            </div>  
                        </div>
                    </div>
                ...
                <div class="article col-md-4 mb-4">
                    <div class="boxtrain">
                        ...
                        <div class="word2">
                            <div class="word3">
                                <h4>磨光與上漆</h4>
                                <p>將完成的產品雛型進行磨光、上保護漆或亮光漆，重複反覆數次後，將木頭產品的質感更上一層樓。
